  ...
  <div class="assistant-shell">
    <header class="assistant-topbar">
      ...
      <nav class="assistant-route-actions" aria-label="Assistant 工作台出口">
        <button ref="historyButton" class="mobile-history-command" type="button" aria-label="打开研究历史" @click="historyRequest += 1">
          <Menu :size="18" aria-hidden="true" />
          <span>历史</span>
        </button>
        <button type="button" aria-label="打开研究资料" @click="evidenceRequest += 1">
