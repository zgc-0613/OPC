...
.process-body li small { color: #5f665f !important; }
.drawer-layer{position:fixed;z-index:100;inset:0}.drawer-backdrop{position:absolute;inset:0;width:100%;border:0;background:rgba(25,28,25,.28)}.citation-drawer{position:absolute;top:0;right:0;bottom:0;width:min(430px,94vw);max-width:100%;overflow-x:hidden;overflow-y:auto;border-left:1px solid #adb3ac;background:#fbfbf7;color:#252a25;}.citation-drawer>header{position:sticky;z-index:2;top:0;display:flex;align-items:flex-start;justify-content:space-between;gap:16px;padding:20px;border-bottom:1px solid #ccd0ca;background:#fbfbf7}.citation-drawer h2{margin:5px 0 0;font-family:'Noto Serif SC',STSong,SimSun,serif;font-size:1.2rem;font-weight:500}.caption{color:#727972;font-family:'Bookman Old Style',Georgia,serif;font-size:.64rem;font-weight:700}.citation-drawer header button{display:grid;place-items:center;width:44px;height:44px;border:1px solid transparent;background:transparent}.citation-drawer header button:focus-visible{border-color:#bfc5bd;background:#f0f1ec}.citation-drawer header button:focus-visible{outline:2px solid rgba(74,82,74,.34);outline-offset:2px}.drawer-state{margin:16px 20px 0;padding:10px;border:1px solid #d0d4ce;background:#f2f2ec;color:#5c635c}.drawer-state.is-error{border-color:#d5b9b4;background:#f8efec;color:#703731}.citation-list,.process-body>ol{margin:0;padding:0 20px 30px;list-style:none}.citation-list li,.process-body li{display:grid;grid-template-columns:30px minmax(0,1fr);gap:10px;padding:18px 0;border-bottom:1px solid #d3d7d1}.citation-list li>span,.process-body li>span{color:#5f665f;font-family:'Bookman Old Style',Georgia,serif;font-size:.7rem}.citation-list li div{display:grid;min-width:0;gap:5px}.citation-list strong{overflow-wrap:anywhere}.citation-list small{color:#5f665f}.citation-list p{margin:5px 0;overflow-wrap:anywhere;color:#505750;line-height:1.6}.citation-list em{color:#3b6549;font-size:.68rem;font-style:normal}.citation-list a{display:inline-flex;align-items:center;gap:5px;min-height:38px;color:#315c42;font-size:.73rem;font-weight:700}.process-body>p{padding:20px;color:#6c736c}.process-summary{display:grid;grid-template-columns:1fr 1fr;gap:1px;margin:20px;border:1px solid #d0d4ce;background:#d0d4ce}.process-summary span{display:grid;gap:3px;padding:12px;background:#fbfbf7;font-size:.75rem}.process-summary small{color:#777d76;font-size:.62rem}.process-body li div{display:grid;gap:4px}.process-body li small{color:#777d76}.process-empty{padding-top:0!important}@media (hover: hover) and (pointer: fine){.citation-drawer header button:hover{border-color:#bfc5bd;background:#f0f1ec}}@media(max-width:640px),(pointer:coarse){.citation-list a{min-height:44px}.citation-drawer header button{min-width:44px;min-height:44px}}@media (min-width:641px) and (max-width:1023px) and (pointer:coarse){.citation-list a,.citation-drawer header button{min-height:44px}.citation-drawer header button{min-width:44px}}
