<template>
  <Teleport to="body">
    <div v-if="open" ref="layer" class="drawer-layer">
      ...
      <aside ref="drawer" class="citation-drawer" role="dialog" aria-modal="true" :aria-labelledby="mode === 'citations' ? 'citation-title' : 'process-title'" @keydown="handleKeydown">
        <header>
...
const props = defineProps({ open: Boolean, restoreFocus: { type: Boolean, default: true }, mode: { type: String, default: 'citations' }, citations: { type: Array, default: () => [] }, run: { type: Object, default: null }, loading: Boolean, error: { type: String, default: '' } })
